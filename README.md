...
Everything generated by the pipeline is committed — no need to run anything to browse the data:
...
| [`data/processed/features_merged.csv`](https://github.com/JiveOff/bs-map-classifier/blob/main/data/processed/features_merged.csv) | Full feature matrix — 473 maps × 263 numeric features |
| [`data/processed/pattern_features.csv`](https://github.com/JiveOff/bs-map-classifier/blob/main/data/processed/pattern_features.csv) | Note-level pattern features only (202 features) |
