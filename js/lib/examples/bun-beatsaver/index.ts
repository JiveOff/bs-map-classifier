...
console.log(`\nNJS ${features.njs}  JD ${features.jump_distance?.toFixed(2)}  RT ${(features.reaction_time * 1000)?.toFixed(0)}ms  NPS ${features.nps_mapped?.toFixed(2)}  Patterns ${patterns.length}`);
